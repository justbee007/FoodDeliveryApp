...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private final RestaurantDirectory rest;
    private final CustomerDirectory cus;
    private final WorkQueue queue;
    private final DeliveryManDirectory deliver;
    ...
    public MainJFrame() {
       ...
       system = dB4OUtil.retrieveSystem();
        ...
        { this.rest = new RestaurantDirectory();
        }
        else
        {
        this.rest = system.getRestaurantDirectory();
        }
        if(system.getCustomerDirectory()==null)
        { this.cus = new CustomerDirectory();
        }
        else
        {
        this.cus = system.getCustomerDirectory();
        }
        ...
        {
            this.queue = system.getWorkQueue();
        }
        if(system.getDeliveryManDirectory()==null)
        { this.deliver = new DeliveryManDirectory();
        }
        else
        { this.deliver = system.getDeliveryManDirectory();
        }
    ...
    private void loginJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginJButtonActionPerformed
        ...
        if(useraccount==null)
        {  JOptionPane.showMessageDialog(this,"Enter a valid credentials");
        }
        else
        { CardLayout layout = (CardLayout)container.getLayout();
            container.add("workarea",useraccount.getRole().createWorkArea(container, useraccount, system,rest,cus,queue,deliver));
